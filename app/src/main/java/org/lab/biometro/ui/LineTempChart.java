 ...
 *
 */
public class LineTempChart extends View {
    ...
    private static final int MOVING_LINE_COLOR = 0xC8F15922;
    private static final int BROKEN_LINE_COLOR = 0xC8F15922;
    private static final int LINEAR_GRADIENT_START_COLOR = 0x32F37A4E;
    private static final int LINEAR_GRADIENT_STOP_COLOR = 0x0AF37A4E;
    private static final int POINT_INNER_COLOR = 0xC8F15922;
    private static final int POINT_OUTER_COLOR = 0xC8F15922;
    private static final int BOTTOM_TIP_FRAME_COLOR = 0xC8F15922;
    private static final int LEFT_TIP_FRAME_COLOR = 0xC8F15922;
...
//    float bottomVerticalLineHeight = 20f;
    ...
    static String levelFormat = "%.1f";

    private Context mContext;

    public LineTempChart(Context context) {
        this(context, null);
    }

    public LineTempChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineTempChart(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            }
    ...
    private void drawMovingLine(Canvas canvas) {
        if (isDrawMoveLine) {
            ...
            float dash = AppUtil.dp2px(mContext, movingLineDashDip);
...

            {
                ...
                Rect rect = new Rect();
                mTipPaint.reset();
                mTipPaint.setTextSize(AppUtil.sp2px(mContext, textSize));
