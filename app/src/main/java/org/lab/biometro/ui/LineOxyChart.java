 ...
 *
 */
public class LineOxyChart extends View {
    ...
    private static final int MOVING_LINE_COLOR = 0xC82BBB9D;
    private static final int BROKEN_LINE_COLOR = 0xC82BBB9D;
    private static final int LINEAR_GRADIENT_START_COLOR = 0x322BBB9D;
    private static final int LINEAR_GRADIENT_STOP_COLOR = 0x0A2BBB9D;
    private static final int POINT_INNER_COLOR = 0xC82BBB9D;
...
//    float bottomVerticalLineHeight = 20f;
    ...
    public LineOxyChart(Context context) {
        this(context, null);
    }

    public LineOxyChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineOxyChart(Context context, AttributeSet attrs, int defStyleAttr) {
